...
| `-sps, --slot-prompt-similarity SIMILARITY` | how much of the cached prompt of a slot must be re-sent by a request in order to use that slot (default: 0.10, 1.0 = full match, 0.0 = disabled) |
